...
def house(x,y,z,h,w,l,m,roofname):
    ...
    mc.setBlocks(x, y, z, x+w, y, z+l, m)
    mc.setBlocks(x, y, z, x+l, y+h, z, m)
    mc.setBlocks(x, y, z, x, y+h z+w, m)
    mc.setBlocks(x,y+2, z+4, x, y+4, z+6, m)
...
for a in range (0,3):
    for b in range (0,3):
      house (271+15*a,56,200+15*b,10,10,10,1,"C:\Users\10492\Desktop\tribe.csv")
