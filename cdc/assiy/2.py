...
APP_ID = '37629871'
API_KEY = "D63IUlIH2VCLUQWL23slkjHLou"
SECRET_KEY = "BL:JKSDFuSJIUIFJHAQOfjl^DKLJ:fjasdfoIOJ"
...
voice=client.synthesis("吃什么",'zh',6,{'vol':15,'per':3,'spd':5})
...
answer1="这就为您搜索"+str(result['result'])
